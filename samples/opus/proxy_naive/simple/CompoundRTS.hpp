...
public:
    ...
    {
        return IntDouble {m_proxy_2, PROXY_2_INTDOUBLE1_OFFSET};
    }
    ...
    {
        return Double {m_proxy_3, PROXY_3_DOUBLE1_OFFSET};
    }

    Double get_Double2() const noexcept
    {
        return Double {m_proxy_3, PROXY_3_DOUBLE2_OFFSET};
    }

    Double get_Double3() const noexcept
    {
        return Double {m_proxy_3, PROXY_3_DOUBLE3_OFFSET};
    }
    ...
    {
        return CompoundCTS {m_proxy_4, PROXY_4_COMPOUNDCTS1_OFFSET};
    }

    Float get_Float1() const noexcept
    {
        return Float {m_proxy_4, PROXY_4_FLOAT1_OFFSET};
    }

    IntDouble get_IntDouble2() const noexcept
    {
        return IntDouble {m_proxy_4, PROXY_4_INTDOUBLE2_OFFSET};
    }

    IntDouble get_IntDouble3() const noexcept
    {
        return IntDouble {m_proxy_4, PROXY_4_INTDOUBLE3_OFFSET};
    }
...
private:
    ...
    static constexpr offset_t PROXY_2_SIZEOF = IntDouble::SIZEOF;
    static constexpr offset_t PROXY_2_INTDOUBLE1_OFFSET = 0;

    static constexpr offset_t PROXY_3_SIZEOF = Double::SIZEOF
                                               + Double::SIZEOF
                                               + Double::SIZEOF;
    static constexpr offset_t PROXY_3_DOUBLE1_OFFSET = 0;
    static constexpr offset_t PROXY_3_DOUBLE2_OFFSET = PROXY_3_DOUBLE1_OFFSET + Double::SIZEOF;
    static constexpr offset_t PROXY_3_DOUBLE3_OFFSET = PROXY_3_DOUBLE2_OFFSET + Double::SIZEOF;

    static constexpr offset_t PROXY_4_SIZEOF = CompoundCTS::SIZEOF
                                               + Float::SIZEOF
                                               + IntDouble::SIZEOF
                                               + IntDouble::SIZEOF;

    static constexpr offset_t PROXY_4_COMPOUNDCTS1_OFFSET = 0;
    static constexpr offset_t PROXY_4_FLOAT1_OFFSET = PROXY_4_COMPOUNDCTS1_OFFSET + CompoundCTS::SIZEOF;
    static constexpr offset_t PROXY_4_INTDOUBLE2_OFFSET = PROXY_4_FLOAT1_OFFSET + Float::SIZEOF;
    static constexpr offset_t PROXY_4_INTDOUBLE3_OFFSET = PROXY_4_INTDOUBLE2_OFFSET + IntDouble::SIZEOF;

...
//    static constexpr size_t MAX_META_ARRAY_SIZE = 128;
...
//    static constexpr size_t MAX_META_ELEMENT_TAGS_DICTIONARY_VALUE_SIZE = 1024;
    ...
    static constexpr size_t MAX_META_ARRAY_SIZE = 128;
    static constexpr size_t MAX_META_ELEMENT_TAGS_DICTIONARY_SIZE = 128;
    static constexpr size_t MAX_META_ELEMENT_TAGS_DICTIONARY_KEY_SIZE = 128;
    static constexpr size_t MAX_META_ELEMENT_TAGS_DICTIONARY_VALUE_SIZE = 128;

...
//    static constexpr size_t MAX_SERIES_SERIES_DATA_ELEMENT_ARRAY_SIZE = 1024;
//    static constexpr size_t MAX_SERIES_TIME_ARRAY_SIZE = 1024;
//    static constexpr size_t MAX_SERIES_META_ARRAY_SIZE = 128;
...
//    static constexpr size_t MAX_SERIES_META_ELEMENT_NAME_SIZE = 256;
//    static constexpr size_t MAX_SERIES_META_ELEMENT_COLOR_SIZE = 256;
//    static constexpr size_t MAX_SERIES_META_ELEMENT_MAX_HOSTS_ARRAY_SIZE = 256;
//    static constexpr size_t MAX_SERIES_META_ELEMENT_MAX_HOSTS_ELEMENT_SIZE = 256;
//    static constexpr size_t MAX_CHUNK_IDS_ARRAY_SIZE = 1024;
    ...
    static constexpr size_t MAX_SERIES_META_ARRAY_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_TAGS_DICTIONARY_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_TAGS_DICTIONARY_KEY_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_TAGS_DICTIONARY_VALUE_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_NAME_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_COLOR_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_MAX_HOSTS_ARRAY_SIZE = 128;
    static constexpr size_t MAX_SERIES_META_ELEMENT_MAX_HOSTS_ELEMENT_SIZE = 128;
    static constexpr size_t MAX_CHUNK_IDS_ARRAY_SIZE = 1024;
    return statshouse::GetQueryResponse::Builder::random<MAX_SERIES_SERIES_DATA_ARRAY_SIZE,
                                                         MAX_SERIES_SERIES_DATA_ELEMENT_ARRAY_SIZE,

...
//    static constexpr size_t MAX_HEADERS_DICTIONARY_VALUE_SIZE = 1024;
    static constexpr size_t MAX_URI_SIZE = 512;
    static constexpr size_t MAX_ARGS_DICTIONARY_SIZE = 128;
    static constexpr size_t MAX_ARGS_DICTIONARY_KEY_SIZE = 128;
    static constexpr size_t MAX_ARGS_DICTIONARY_VALUE_SIZE = 128;
    static constexpr size_t MAX_HEADERS_DICTIONARY_SIZE = 128;
    static constexpr size_t MAX_HEADERS_DICTIONARY_KEY_SIZE = 128;
    static constexpr size_t MAX_HEADERS_DICTIONARY_VALUE_SIZE = 128;
